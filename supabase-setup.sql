...
-- Regions
INSERT INTO "Region" ("id","name","slug","state","lat","lng","radiusKm") VALUES ('reg_sfbay','San Francisco','sfbay','CA',37.7749,-122.4194,20) ON CONFLICT ("slug") DO NOTHING;
INSERT INTO "Region" ("id","name","slug","state","lat","lng","radiusKm") VALUES ('reg_nyc','New York City','nyc','NY',40.7128,-74.006,25) ON CONFLICT ("slug") DO NOTHING;
INSERT INTO "Region" ("id","name","slug","state","lat","lng","radiusKm") VALUES ('reg_austin','Austin','austin','TX',30.2672,-97.7431,30) ON CONFLICT ("slug") DO NOTHING;
INSERT INTO "Region" ("id","name","slug","state","lat","lng","radiusKm") VALUES ('reg_portland','Portland','portland','OR',45.5152,-122.6784,25) ON CONFLICT ("slug") DO NOTHING;
INSERT INTO "Region" ("id","name","slug","state","lat","lng","radiusKm") VALUES ('reg_chicago','Chicago','chicago','IL',41.8781,-87.6298,30) ON CONFLICT ("slug") DO NOTHING;
INSERT INTO "Region" ("id","name","slug","state","lat","lng","radiusKm") VALUES ('reg_seattle','Seattle','seattle','WA',47.6062,-122.3321,25) ON CONFLICT ("slug") DO NOTHING;
INSERT INTO "Region" ("id","name","slug","state","lat","lng","radiusKm") VALUES ('reg_denver','Denver','denver','CO',39.7392,-104.9903,30) ON CONFLICT ("slug") DO NOTHING;
INSERT INTO "Region" ("id","name","slug","state","lat","lng","radiusKm") VALUES ('reg_boston','Boston','boston','MA',42.3601,-71.0589,25) ON CONFLICT ("slug") DO NOTHING;
...
INSERT INTO "Listing" ("id","title","description","price","priceLabel","locationName","lat","lng","contactEmail","contactName","contactPhone","showPhone","editToken","regionId","categoryId","status","expiresAt","renewedAt","createdAt","updatedAt") VALUES ('lst_007','Vintage leather satchel, full-grain, beautifully worn','Hand-stitched full-grain leather messenger bag, probably 1980s. No brand label but clearly well-made. Patina is gorgeous — it''s been loved. One interior pocket needs re-stitching (minor). Brass hardware has a nice tarnish. Measures about 16" x 11" x 5".',9500,NULL,'Brooklyn — Greenpoint',40.90876443829183,-74.13073831956095,'theo.b@example.com','Theo',NULL,false,'tok_lst_007_no5sdb1flqf','reg_nyc','sub_clo','ACTIVE','2026-07-28T11:33:21.129Z','2026-06-28T11:33:21.129Z','2026-06-28T11:33:21.129Z','2026-06-28T11:33:21.129Z');
